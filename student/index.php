...
// --- Notifications (modern dismissible alert with icons) ---
$notifications = $conn->query("SELECT * FROM notifications WHERE user_id = $user_id AND is_read = 0 ORDER BY created_at DESC");
if ($notifications && $notifications->num_rows > 0) {
    echo '<div class="alert alert-modern alert-dismissible fade show shadow-sm" role="alert">';
...
<head>
    ...
    <style>
        :root {
            ...
            --card-shadow-hover: 0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.02);
...
<div class="container-fluid px-4 py-4">
    ...
    <div class="welcome-header d-flex flex-wrap justify-content-between align-items-center">
        <div>
            ...
            <p class="text-muted mt-1">Here's your health center summary for today.</p>
        </div>
    ...
    <div class="row g-4 mb-5">
        ...
        <div class="col-md-4 col-xl-3">
            <div class="stat-card p-4">
                ...
                <div class="mt-2 small text-muted">
                    <i class="fas fa-exclamation-triangle me-1"></i> Below reorder level
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="alert alert-warning d-flex align-items-center shadow-sm border-0 rounded-4" style="background: #fff9e6; border-left: 5px solid #f59e0b;">
                ...
                <a href="drug_inventory.php" class="btn btn-sm ms-auto px-3 rounded-pill" style="background: #f59e0b; color: white;">Review Stock</a>
            </div>
        </div>
    </div>
    <?php endif; ?>
